...
build {
  ...
  # Execute the winget-install script directly with parameters.
  provisioner "powershell" {
    inline = [
      "Write-Output 'Installing applications with Winget using asheroto/winget-install...'",
      "Set-ExecutionPolicy Bypass -Scope Process -Force",
      "& 'C:\\Windows\\Temp\\winget-install.ps1' -Apps 'ScooterSoftware.BeyondCompare4','Git.Git','GitHub.cli','Microsoft.GitCredentialManagerCore','Microsoft.PowerShell','Microsoft.WindowsTerminal','Kitware.CMake','Microsoft.VisualStudio.2022.Professional','Microsoft.VisualStudioCode','AgileBits.1Password','AgileBits.1Password.CLI','Canonical.Ubuntu.2204'"
    ]
  }
