...
build {
  ...
  # Upload the winget.ps1 file to the target machine.
  provisioner "file" {
    source      = "./winget.ps1"
    destination = "C:\\Windows\\Temp\\winget.ps1"
  }

  # Execute the uploaded winget script.
  provisioner "powershell" {
    inline = [
      "Write-Output 'Installing applications with Winget...'",
      "Set-ExecutionPolicy Bypass -Scope Process -Force",
      "& 'C:\\Windows\\Temp\\winget.ps1'"
    ]
  }
