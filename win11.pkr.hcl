...
build {
  ...
  # Upload the local winget-install.ps1 file to the VM.
  provisioner "file" {
    source      = "./winget-install.ps1"
    destination = "C:\\Windows\\Temp\\winget-install.ps1"
  }

  # Execute the uploaded winget-install script and install applications.
  provisioner "powershell" {
    inline = [
      ...
      ". 'C:\\Windows\\Temp\\winget-install.ps1'",
      # Invoke the winget-install command with your app list.
